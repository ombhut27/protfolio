    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>om.m.bhut@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Gandhinagr, Gujarat, India</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91 91732 63762</span>
        </motion.div>
      </motion.div>
      ...
      <div className="formContainer">
        ...
        >
          ...
          {success && <span className="success">Your message has been sent successfully!</span>}
        </motion.form>
      </div>
    </motion.div>
  );
